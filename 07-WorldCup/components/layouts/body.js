...
const DEFAULT_DESC = (
  <span>Hi, this is the demo of a music CMS builded with Canner, a schema-based CMS framework. The data model is referenced from <a href="https://www.fifa.com/worldcup/matches/match/300331503/#match-statistics">FIFA</a> and you can check the all components and schema <a href="https://github.com/Canner/cms30/tree/master/07-WorldCup">here</a></span>  
);
